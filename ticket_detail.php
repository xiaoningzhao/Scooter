...
<?php
	...
	if ($result->num_rows > 0) {
		echo "<form page='process_ticket.php'><div class='row gtr-uniform gtr-50'>";
		...
		if($session_jobtype=="Manager"){
			...
			echo "<form page='assign_ticket.php'>Assign Employee<div class='row gtr-uniform gtr-50'><input type='hidden' name='ticket_id' id='ticket_id' value='$uid' />";
