	...
	<body class="is-preload">
				...
				<header id="header">
					...
					<nav id="nav">
						<ul>
							...
							<li><a id="create_ticket" page="create_ticket_page.php" href="#">Create Ticket</a></li>
							<li><a id="edit_profile" page="edit_profile.html" href="#">Edit Profile</a></li>
		...
		<!-- Scripts -->
			...
			$(document).ready(function(){
			    ...
			    $("#content").load("create_ticket_page.php",function(responseTxt,statusTxt,xhr){
		    	});
			});
			...
			$("#edit_profile").click(function(){
				$("#content").load("edit_profile.html",function(responseTxt,statusTxt,xhr){
